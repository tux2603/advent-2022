...
min_y, max_y = min(y_coords), max(y_coords) + 2

min_x, max_x = min([*x_coords, 500 - (2 + max_y - min_y)]) - 1, max([*x_coords, 500 + (2 + max_y - min_y)])
...
# Fill the entire bottom row with #
...
while grid[0 - min_y][500 - min_x] != 'O':
